        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg" id="game-container">
                ...
                <div class="mt-4 flex flex-col items-center relative">
                    <div class="bg-#D9D9D9 px-8 mt-8 pb-8 w-full max-w-screen-lg flex flex-col items-center relative" id="discussion-container">
                        <h1 class="text-xl font-bold mb-4">Discussion Detail</h1>
