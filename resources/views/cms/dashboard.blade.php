...
<html>
  ...
  <body class="m-0 font-sans antialiased font-normal text-base leading-default text-slate-500" style="background-image: url('assets/web/map1.png');">
    <!-- sidenav  -->
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 py-4 pl-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-r-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0">
      <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="javascript:;" target="_blank">
          ...
          <span class="ml-1 font-semibold transition-all duration-200 ease-nav-brand">Viatom Dashboard</span>
        </a>
      </div>
