                    ...
                    <form action="{{ route('cms.atom-experiments.update', ['id' => $atomexperiment->id]) }}" method="POST">
                      ...
                      <div>
                        <div class="form grup mt-4 ">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="title" type="text" value="{{ $atomexperiment->title }}" placeholder="Title">
                        </div>
                        <div class="form grup mt-4 ">
                            <label class="block uppercase tracking-wide text-gray-700 text-base font-bold mb-2">Level</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="level" type="text" value="{{ $atomexperiment->level }}" placeholder="Level">
                        </div>
                        <div class="form grup mt-4 ">
                            <label class="block uppercase tracking-wide text-gray-700 text-base font-bold mb-2">Description</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="description" type="text" value="{{ $atomexperiment->description }}" placeholder="Description">
                        </div>
                        <div class="form grup mt-4 ">
                            <label class="block uppercase tracking-wide text-gray-700 text-base font-bold mb-2">Src</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="src" type="text" value="{{ $atomexperiment->src }}" placeholder="Source">
                        </div>
                        <div class="mt-4">
