                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2 font-serif text-center text-md">
                                        <a href="/cms/atom-experiments/{{$atomexperiment->id}}/edit" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full transition duration-300">Edit</a>
