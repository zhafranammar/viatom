                    ...
                    <form action="{{ route('cms.videos.update', ['id' => $video->id]) }}" method="POST">
                      ...
                      <div>
                        <div class="form grup mt-4 ">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="title" type="text" value="{{ $video->title }}" placeholder="Title">
                        </div>
                        <div class="form grup mt-4 ">
                            <label class="block uppercase tracking-wide text-gray-700 text-base font-bold mb-2">Level</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="level" type="text" value="{{ $video->level }}" placeholder="Level">
                        </div>
                        <div class="form grup mt-4 ">
                            <label class="block uppercase tracking-wide text-gray-700 text-base font-bold mb-2">Video Link</label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="video_url" type="text" value="{{ $video->video_url }}" placeholder="Video Url">
                        </div>
                        <div class="mt-4">
