      ...
      <div class="container text-center">
        ...
        <div class="row">
          ...
          <div class="col" id="box">
            ...
            <button onclick="window.location.href='/auth/google'" class=" btn btn-light flex-nowrap" id="google" type="button" href="/auth/google">
                <a>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="input-group flex-nowrap">
                    <input name="name" type="text" class="form-control" placeholder="Enter you name" aria-label="Enter you name" aria-describedby="addon-wrapping">
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                </div>
                <h3>Email</h3>
                <div class="input-group flex-nowrap">
                    <input name="email" type="text" class="form-control" placeholder="Enter you email" aria-label="Enter you email" aria-describedby="addon-wrapping">
                    <x-input-error :messages="$errors->get('name')" class="mt-2" />
                </div>
                <h3>Password</h3>
                <div class="input-group flex-nowrap">
